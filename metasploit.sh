...
## Add Alvi Toxiz repository to install ruby 2.7.2 version
...
## Set low priority for all alvitoxiz repository (for security purposes)
## Set highest priority for ruby package from gushmazuko repository
# echo '## Set low priority for all alvitoxiz repository (for security purposes)
# Package: *
# Pin: release alvitoxiz
# Pin-Priority: 100

## Set highest priority for ruby package from alvitoxiz repository
# Package: ruby
# Pin: release alvitoxiz
